...
import com.william.reservationsystem.controller.UserHomepage.Fragment.IndentFragment;
...
public class HomepageForUActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RadioButton rb_order, rb_indent, rb_my;
    ...
    private void init() {
        ...
        rb_indent = findViewById(R.id.rad_shopping);
        rb_my = findViewById(R.id.rad_my);

        rb_order.setOnClickListener(this);
        rb_indent.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        init();
        TextPaint order = rb_order.getPaint();
        TextPaint shopping = rb_indent.getPaint();
        ...
        switch (v.getId()) {
            case R.id.rad_order:
                ...
                rb_order.setActivated(true);
                rb_indent.setActivated(false);
                rb_my.setActivated(false);
                rb_order.setTextColor(Color.parseColor("#e9730a"));
                rb_indent.setTextColor(Color.parseColor("#404040"));
            ...
            case R.id.rad_shopping:
                ...
                transaction.replace(R.id.user_content_Layout, indentFragment);
                rb_indent.setActivated(true);
                rb_order.setActivated(false);
                rb_my.setActivated(false);
                rb_indent.setTextColor(Color.parseColor("#e9730a"));
